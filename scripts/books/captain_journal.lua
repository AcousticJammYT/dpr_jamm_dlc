...
function book:init()
    ...
    self.pages = {
        [1] = [[
					   [s:3][b]Entry 1
		[b]Just before setting off on an adventure to the light crystals, a father approached me with his daughter. She was not in very good condition, and the father explained to me that his daughter, named Marcy, was unable to enter the light world due to her condition.
